...
category:drop;
DROP TABLE IF EXISTS dns_srv_record;
category:drop;
DROP TABLE IF EXISTS dns_override_reversemap;
category:drop;
DROP TABLE IF EXISTS dns_override_reversemap_ipv6;
category:drop;
DROP TABLE IF EXISTS dns_general_dns_record;
category:drop;
DROP TABLE IF EXISTS dns_field_type_code;
category:drop;
DROP TABLE IF EXISTS dns_cname_record;
category:drop;
DROP TABLE IF EXISTS dns_host_info;
category:drop;
DROP TABLE IF EXISTS dns_a_record;
category:drop;
DROP TABLE IF EXISTS dns_aaaa_record;
category:drop;
DROP TABLE IF EXISTS dns_ip_number;
category:drop;
DROP TABLE IF EXISTS dns_ipv6_number;
category:drop;
DROP TABLE IF EXISTS dns_mx_set_member;
category:drop;
ALTER TABLE dns_owner DROP CONSTRAINT IF EXISTS dns_owner_mx_set_fk;
category:drop;
DROP TABLE IF EXISTS dns_mx_set;
category:drop;
DROP TABLE IF EXISTS dns_owner;
category:drop;
DROP TABLE IF EXISTS dns_zone;
category:drop;
DROP TABLE IF EXISTS dns_entity_note;
category:drop;
DROP TABLE IF EXISTS dns_entity_note_code;
category:drop;
DROP TABLE IF EXISTS dns_subnet;
category:drop;
DROP TABLE IF EXISTS dns_ipv6_subnet;
category:drop;
DROP SEQUENCE IF EXISTS ip_number_id_seq;

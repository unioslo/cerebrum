...
(
  ...
  total_memory		NUMERIC(12,0),
  node_number		NUMERIC(12,0),
  node_memory		NUMERIC(12,0),
  node_disk		NUMERIC(12,0),
  cpu_core_number	NUMERIC(12,0),
  cpu_core_mflops	NUMERIC(12,0),
  cpu_mhz		NUMERIC(12,0),
  credit_production	NUMERIC(12,0),
  cpu_arch		NUMERIC(6,0)
			NOT NULL
			CONSTRAINT machine_info_cpu_arch
			  REFERENCES cpu_arch_code(code),
  operating_system	NUMERIC(6,0)
			NOT NULL
			CONSTRAINT machine_info_operating_system
			  REFERENCES operating_system_code(code),
  interconnect		NUMERIC(6,0)
			NOT NULL

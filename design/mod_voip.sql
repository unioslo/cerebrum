...
(
        ...
        mac_address      CHAR(17)
                         ...
                         CONSTRAINT voip_client_mac_check
                           CHECK ((mac_address IS NULL AND 
                                   client_type = [:get_constant name=voip_client_type_softphone]) OR
                                  (mac_address IS NOT NULL AND
				   client_type = [:get_constant name=voip_client_type_hardphone])),
        client_info      NUMERIC(6, 0)
                         NOT NULL

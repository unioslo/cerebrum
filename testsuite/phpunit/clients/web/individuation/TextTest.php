...
/**
 * Class for testing the Text functionality that is specific to the 
 * individuation project.
 */
class IndividuationTextTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        Text::setLocation(TEST_PREFIX_CEREBRUM . '/clients/web/individuation/data/txt/uio');
    }

...
<wsdl:definitions targetNamespace=\"http://bas.ntnu.no/spinews.wsdl\" xmlns=\"http://schemas.xmlsoap.org/wsdl/\" xmlns:ns1=\"http://bas.ntnu.no/spinews.wsdl\" xmlns:wsdl=\"http://schemas.xmlsoap.org/wsdl/\" xmlns:wsdlsoap=\"http://schemas.xmlsoap.org/wsdl/soap/\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\">
...
<xs:schema targetNamespace=\"http://bas.ntnu.no/spinews.wsdl\">
  ...
  <xs:complexType name=\"GroupType\">
    <xs:sequence>
      ...
      <xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"quarantine\" type=\"xs:string\"/>
    </xs:sequence>
  ...
  <xs:complexType name=\"AccountType\">
    <xs:sequence>
      <xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"quarantine\" type=\"xs:string\"/>
      <xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"affiliation\" type=\"ns1:AffiliationType\"/>
    </xs:sequence>
    <xs:attribute name=\"name\" type=\"xs:string\"/>
  ...
  <xs:complexType name=\"PersonType\">
    <xs:sequence>
      <xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"quarantine\" type=\"xs:string\"/>
      <xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"affiliation\" type=\"ns1:AffiliationType\"/>
      <xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"trait\" type=\"xs:integer\"/>
    </xs:sequence>
  ...
  <xs:element name=\"getAccountsResponse\">
    <xs:complexType>
      <xs:sequence>
	<xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"account\" type=\"ns1:AccountType\"/> 
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name=\"getPersonsResponse\">
    <xs:complexType>
      <xs:sequence>
	<xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"person\" type=\"ns1:PersonType\"/>
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name=\"getGroupsResponse\">
    <xs:complexType>
      <xs:sequence>
	<xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"group\" type=\"ns1:GroupType\"/>
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name=\"getOUsResponse\">
    <xs:complexType>
      <xs:sequence>
	<xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"ou\" type=\"ns1:OUType\"/> 
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name=\"getAliasesResponse\">
    <xs:complexType>
      <xs:sequence>
	<xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"alias\" type=\"ns1:AliasType\"/>
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name=\"getHomedirsResponse\">
    <xs:complexType>
      <xs:sequence>
	<xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"homedir\" type=\"ns1:HomedirType\"/> 
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name=\"getGroupsRequest\">
	...
	<xs:element minOccurs=\"0\" name=\"incremental_from\" type=\"xs:integer\"/> 
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name=\"getAccountsRequest\">
	...
	<xs:element minOccurs=\"0\" name=\"incremental_from\" type=\"xs:integer\"/>
	<xs:element minOccurs=\"0\" name=\"include_affiliations\" type=\"xs:integer\"/>
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name=\"getPersonsRequest\">
    <xs:complexType>
      <xs:sequence>
	<xs:element minOccurs=\"0\" name=\"personspread\" type=\"xs:string\"/>
	<xs:element minOccurs=\"0\" name=\"accountspread\" type=\"xs:string\"/>
	<xs:element minOccurs=\"0\" name=\"incremental_from\" type=\"xs:integer\"/>
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name=\"getAliasesRequest\">
    <xs:complexType>
      <xs:sequence>
	<xs:element minOccurs=\"0\" name=\"incremental_from\" type=\"xs:integer\"/>
	<xs:element minOccurs=\"0\" name=\"emailserver\" type=\"xs:string\"/>
      </xs:sequence>
    </xs:complexType>
  </xs:element>
...
<wsdl:binding name=\"cerewsBinding\" type=\"ns1:cerewsPortType\">
...
<wsdl:service name=\"cerews\">
  <wsdl:port binding=\"ns1:cerewsBinding\" name=\"cerewsPort\">
    ...
    def soap_get_accounts(self, ps):
        self.request = ps.Parse(getAccountsRequest.typecode)
        return getAccountsResponse()

    soapAction[''] = 'soap_get_accounts'
    root[(getAccountsRequest.typecode.nspname,getAccountsRequest.typecode.pname)] = 'soap_get_accounts'

    def soap_get_persons(self, ps):
        self.request = ps.Parse(getPersonsRequest.typecode)
        return getPersonsResponse()

    soapAction[''] = 'soap_get_persons'
    root[(getPersonsRequest.typecode.nspname,getPersonsRequest.typecode.pname)] = 'soap_get_persons'

    def soap_get_groups(self, ps):
        self.request = ps.Parse(getGroupsRequest.typecode)
        return getGroupsResponse()

    soapAction[''] = 'soap_get_groups'
    root[(getGroupsRequest.typecode.nspname,getGroupsRequest.typecode.pname)] = 'soap_get_groups'

    def soap_get_ous(self, ps):
        self.request = ps.Parse(getOUsRequest.typecode)
        return getOUsResponse()

    soapAction[''] = 'soap_get_ous'
    root[(getOUsRequest.typecode.nspname,getOUsRequest.typecode.pname)] = 'soap_get_ous'

    def soap_get_aliases(self, ps):
        self.request = ps.Parse(getAliasesRequest.typecode)
        return getAliasesResponse()

    soapAction[''] = 'soap_get_aliases'
    root[(getAliasesRequest.typecode.nspname,getAliasesRequest.typecode.pname)] = 'soap_get_aliases'

    def soap_get_homedirs(self, ps):
        self.request = ps.Parse(getHomedirsRequest.typecode)
        return getHomedirsResponse()

    soapAction[''] = 'soap_get_homedirs'
    root[(getHomedirsRequest.typecode.nspname,getHomedirsRequest.typecode.pname)] = 'soap_get_homedirs'

    def soap_set_homedir_status(self, ps):
        self.request = ps.Parse(setHomedirStatusRequest.typecode)
        return setHomedirStatusResponse()

    soapAction[''] = 'soap_set_homedir_status'
    root[(setHomedirStatusRequest.typecode.nspname,setHomedirStatusRequest.typecode.pname)] = 'soap_set_homedir_status'

    def soap_get_changelogid(self, ps):
        self.request = ps.Parse(getChangelogidRequest.typecode)
        return getChangelogidResponse()

    soapAction[''] = 'soap_get_changelogid'
    root[(getChangelogidRequest.typecode.nspname,getChangelogidRequest.typecode.pname)] = 'soap_get_changelogid'

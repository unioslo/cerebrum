...
class Disk(EntitySpread, Entity_class):
    ...
    def __eq__(self, other):
        ...
        if not super(Disk, self).__eq__(other):
            return False
...
class Host(EntityName, EntitySpread, Entity_class):
    ...
    def __eq__(self, other):
        ...
        if not super(Host, self).__eq__(other):
            return False
    ...
    def find_by_name(self, name):
        ...
        If name isn't an existing Host identifier, NotFoundError is raised.
        """

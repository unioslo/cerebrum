...
class Individuation(Individuation.Individuation):
    ...
    messages = {
        ...
        'account_reserved':  {'en': u'You are blocked from using this service. Please contact your local IT.',
                              'no': u'Du er blokkert fra å bruke denne tjenesten. Vennligst ta kontakt med din lokale IT-avdeling.'},
        ...
        'token_notsent':     {'en': u'Could not send one-time password to your phone',
        ...
        'fresh_phonenumber': {'en': u'Your phone number has recently been changed in StudWeb, and can not, due to security reasons, be used ' +

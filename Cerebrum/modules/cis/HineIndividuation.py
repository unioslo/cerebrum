...
"""
Functionality for the Individuation project that is specific to HiNesna.
"""

from Cerebrum.modules.cis import Individuation

class Individuation(Individuation.Individuation):
    """HiNe specific behaviour for the individuation service."""

    # The subject of the warning e-mails
    email_subject = 'Failed password recovery attempt'

    # The signature of the warning e-mails
    email_signature = 'Høyskolen i Nesna'

    # The from address
    email_from = 'noreply@hinesna.no'
    # The feedback messages for HiNe
    messages = {

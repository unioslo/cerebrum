...
class NMHStudent(access_FS.Student):
    ...
    def list_aktiv(self):
        ...
        Studentstatuskode kan vere av forskjellige typer, NMH ¯nsker ogsÂ at
        studenter som har sluttet pÂ et program fremdeles skal ha tilgang til
        sluttdatoen er passert. Som rutine i FS skal alltid sluttdatoen
        oppdateres nÂr status endres, sÂ dette gj¯r at de kan styre nÂr
        ...
        WHERE p.fodselsdato = sps.fodselsdato AND
          ...
          sps.studentstatkode IN ('AKTIV', 'PERMISJON', 'FULLFÿRT',
...
class NMHUndervisning(access_FS.Undervisning):
    ...
    # Pr¯ve Â lage generell list_studenter_kull.
    # Pr¯ve Â fjerne behov for override-metoder her

    def list_undervisningenheter(self, sem=None):
        """Henter undervisningsenheter i nÂverende (current) og/eller neste
        (next) semester. Default er bÂde nÂvÊrende og neste semeter, sÂ en fÂr
        med enhetene til undervisningsaktiviteter som gÂr over to semester.

        For hver undervisningsenhet henter vi institusjonsnr, emnekode,
        versjonskode, terminkode + Ârstall, terminnr samt hvorvidt enheten skal
        eksporteres til LMS."""
    ...
    def list_aktiviteter(self, start_aar=time.localtime()[0],
                         start_semester=None):
        """Henter info om undervisningsaktiviteter for innevÊrende
        semester. For hver undervisningsaktivitet henter vi
        institusjonsnr, emnekode, versjonskode, terminkode + Ârstall,
        terminnr, aktivitetskode, underpartil¯penummer, disiplinkode,
    ...
    def list_studenter_underv_enhet(self,
                                    ...
                                    arstall,
                                    terminnr):
        """Finn f¯dselsnumrene til alle studenter pÂ et gitt
        undervisningsenhet. Skal brukes til Â generere grupper for
        adgang til CF."""
        qry = """
        SELECT DISTINCT
    ...
    def list_studenter_kull(self, studieprogramkode, terminkode, arstall):
        """Hent alle studentene som er oppf¯rt pÂ et gitt kull."""
    ...
    def list_fagperson_semester(self):
        """Hent ut data om fagpersoner. NMH har et tilleggsbehov for Â hente ut

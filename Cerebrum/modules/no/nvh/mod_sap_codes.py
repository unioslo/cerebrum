...
"""
This file provides code values to be used with the instance' SAP extension to
Cerebrum -- mod_sap.
"""
...
class SAPConstants(Constants.Constants):
    """
    This class embodies all constants that we need to address the HR-related
    tables.
    """
    ...
    sap_0000_ekstern_stillingskode = SAPLonnsTittelKode(
        "00000000",
        "0000 Ekstern tilsatt, ikke lønnet av NVH",
        "ØVR"
    )

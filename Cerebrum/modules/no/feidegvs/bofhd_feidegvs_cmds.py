...
class BofhdExtension(object):
    ...
    def _group_count_memberships(self, entity_id, spread):
        ...
        candidates = list(gr.search(member_id=entity_id,
    ...
    def group_user(self, operator, accountname):
        ...
        for row in group.search(member_id=account.entity_id,
            ...
            ret.append({'memberop': str(self.num2const[
                                        int(self.const.group_memberop_union)]),
...
# arch-tag: 01797ee6-187c-11da-961f-3b6c6cd6fb60

...
# temporary hack for HiA until bofhd is reorganized
# this file is to be kept in modules/no/hia/auth.py, symlinked
# to modules/bofhd/auth.py
#            return account.get_home(self.const.spread_uio_nis_user)
            return account.get_home(self.const.spread_nis_user)
        except Errors.NotFoundError:
            return None
...
# arch-tag: adc9aee3-62c6-4705-aeef-56e5dc5a0e34

...
class OrgLdifUitMixin:
    ...
    def make_person_entry(self, row):
        ...
        if qt:
            ...
            if qh.is_locked():
                passwd = 0
        if passwd:
            #UIT: Changed {crypt} to {Md5} below
    ...
    def init_account_info(self):
        ...
        fill_passwd = {
            # Uit: removed md5_crypt and crypt3_des and added md5_b64
    ...
    def generate_person(self, outfile, alias_outfile, use_mail_module):
        ...
        # UIT: All above is identical to OrgLDIF.py in modules folder
        #print "Calling gen_sys_obj"
    ...
    def generate_org_object(self, outfile):
        ...
        # UIT: added dcObject to to org_object
        oc = ['top', 'organization', 'eduOrg','dcObject']
        #oc = ['top', 'organization', 'eduOrg']
        oc.extend(entry.get('objectClass', ()))
        # UIT: added dcObject to entry ['objectClass']
        entry['objectClass'] = (['top', 'organization', 'eduOrg','dcObject']
                                + list(entry.get('objectClass', ())))
        self.update_org_object_entry(entry)
        # Uit: added the next line
        entry['o'] = (['University of Tromsoe'])

...
"""
This module implements authorization helpers for voip bofhd commands.
...
class BofhdVoipAuth(auth.BofhdAuth):
    ...
    #
    def can_alter_number(self, account_id, query_run_any=False):
        """Whether account_id can alter voip phone numbers."""
    ...
    def can_alter_voip_address(self, account_id, query_run_any=False):
    ...
    #
    def can_create_voip_client(self, account_id, query_run_any=False):
    ...
    def can_view_voip_client(self, account_id, query_run_any=False):
    ...
    def can_alter_voip_client(self, account_id, query_run_any=False):
    ...
    def can_reset_client_secrets(self, account_id, client_id=None,
                                 query_run_any=False):
    ...
    def can_set_new_secret(self, account_id, client_id=None,
                           query_run_any=False):
    ...
    #
    def can_create_voip_service(self, account_id, query_run_any=False):
    ...
    def can_view_voip_service(self, account_id, query_run_any=False):
        """Everybody can see information about voip_services."""
        return True

    def can_alter_voip_service(self, account_id, query_run_any=False):

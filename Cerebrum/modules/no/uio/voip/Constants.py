...
class _VoipServiceTypeCode(Constants._CerebrumCode):
    """
...
class _VoipClientTypeCode(Constants._CerebrumCode):
    """
...
class _VoipClientInfoCode(Constants._CerebrumCode):
    """
...
class _EntityAuthenticationCode(Constants._CerebrumCode):
    """
...
class VoipAuthConstants(Constants.Constants):
    ...
    auth_type_ha1_md5 = Constants._AuthenticationCode(
        'HA1-MD5',
...
class VoipConstants(Constants.Constants):
    ...
    ########################################################################
    # generic voip stuff
    system_voip = Constants._AuthoritativeSystemCode(
        'VOIP',
        'Data from voip',
    )
    ...
    ########################################################################
    # voip-service
    entity_voip_service = Constants._EntityTypeCode(
        "voip_service",
    ...
    ########################################################################
    # voip-client
    entity_voip_client = Constants._EntityTypeCode(
        'voip_client',
    ...
    ########################################################################
    # voip-address
    entity_voip_address = Constants._EntityTypeCode(
        'voip_address',

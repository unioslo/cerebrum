...
command_help = {
    "voip": {
        "voip_service_new": "Create a new voip service.",
        "voip_service_info": "Display information about a voip service.",
        "voip_service_type_list": "Show available voip_service types.",
        "voip_service_delete": "Remove a voip service from Cerebrum.",
        "voip_service_update": "Update data of a voip service.",
        "voip_service_find": "Find all voip_services matching criteria.",
        
        "voip_client_new": "Create a new voip client.",
        "voip_client_info": "Display information about a voip client.",
        "voip_client_list_info_code": "Show all available voip_client info codes.",
        "voip_client_list_type_code": "Show all available voip_client type codes.",
        "voip_client_delete": "Delete (completely) a voip_client from Cerebrum.",

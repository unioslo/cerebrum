...
LDAP_SUBNETS = {
    ...
    # Names for optional LDAP attributs with IP addresses of a subnet
    # range converted to integers (as with inet_addr).
    ...
    #'rangeTypes': (startType, endType): attrs for integer subnet range
}

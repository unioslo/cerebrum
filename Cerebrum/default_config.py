...
LDAP_PERSON = {
    ...
    #
    # Which authentication method to use for export of users to LDAP. Tuple
    # with the highest priority one first.
    #
    # Example ('auth_type_sha256_crypt', 'auth_type_md5_crypt',)
    #
    'auth_methods': ('auth_type_md5_crypt',),
}

...
public class EphorteGW {
    ...
    /**
     * Henter ut informasjon om definerte personer++ i ePhorte. S√•vidt vi vet,
     * er det stort sett kun GetDataSet som kan benyttes til √• liste data i
     * ePhorte, og denne metoden returnerer en relativt r√• dump av en enkelt
     * tabell i basen. Vi m√• derfor dumpe flere tabeller, og skj√∏te sammen data
     * manuelt basert p√• kjennskap til fremmedn√∏kler i datamodellen.
     * 
     */
    private void fetchPersons() throws RemoteException, TooManyRecordsException {
        /*
         * F√∏lgende er eksempler p√• datastrukturer returnert med ePhortes
	...
	// Check if Person needs to be updated
		...
		// TODO: Vi kommer ikke hit nÂr vi sletter/setter
		// tildato/setter delete="1" pÂ en person. Hvorfor?
    ...
    private boolean updateTgKoder(XMLUtil xml, Person p) {
		...
		// Hvis operatorPerson ikke finnes mÂ vi finne pÂ noe

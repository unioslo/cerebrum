<span tal:define="title string:Personer;title_id string:person_find_res" tal:omit-tag=""><span metal:use-macro="tpl/macros/page">
<span metal:fill-slot="body" tal:omit-tag="">

<span tal:condition="not:personlist" tal:omit-tag="">
Ingen personer oppfyller dine søkekriterier.
</span>

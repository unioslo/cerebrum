...
"""Imports information from FS into Cerebrum

This imports persons, study programs, courses and groups from files. These
files are generated by the import_from_FS.py script.

 - The study programme file is usually named studieprog.xml
 - The course info file is usually named emner.xml
 - The persons file is usually named merged_persons.xml and is generated by
   combining several of the output files of import_from_FS.py into one using
   the merge_xml_files.py script.
...
def main():
    ...
    fs_importer = FsImporterUio(args.gen_groups,
                                ...
                                args.studieprogramfile, args.source, rules,
                                adr_map, args.emnefile, rule_map)

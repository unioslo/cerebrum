...
class PopulateEphorte(object):
    def __init__(self, ephorte_sko_file):
        ...
        ## TODO: Disse hardkodede sko-ene burde fjernes, eller i hvert
        ##       fall legges i cereconf.
        ...
        logger.info("Fetching OU info from ePhorte")
        ...
        logger.debug2("Known ephorte sko: %s" % ", ".join(
    ...
    def run(self):
        ...
        for row in pe.list_affiliations(source_system=co.system_sap,
            ...
            if ou_id is None:
                ...
                logger.info("Failed mapping '%s' to known ePhorte sko" %
        ...
        for person_id, ous in person2ou.items():
            ...
            # logger.debug("Process pid=%i, ous=%s, old=%s" % (
            #     person_id, repr(ous), existing_roles))
            for t in ous:
            ...
            for er in existing_roles:
                # Only saksbehandler role can be removed
...
def main():
    ...
    for opt, val in opts:
        if opt in ('--help',):
            ...
            # pop = PopulateEphorte("/cerebrum/dumps/EPHORTE/ephorte-steder.dat")

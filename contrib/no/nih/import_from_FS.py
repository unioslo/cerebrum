...
default_person_file = pj(cereconf.FS_DATADIR, "person.xml")
default_role_file = pj(cereconf.FS_DATADIR, "roles.xml")
default_undvenh_file = pj(cereconf.FS_DATADIR, "underv_enhet.xml")
default_undenh_student_file = pj(cereconf.FS_DATADIR, "student_undenh.xml")
default_studieprogram_file = pj(cereconf.FS_DATADIR, "studieprog.xml")
default_ou_file = pj(cereconf.FS_DATADIR, "ou.xml")
default_emne_file = pj(cereconf.FS_DATADIR, "emner.xml")
default_fnr_update_file = pj(cereconf.FS_DATADIR, "fnr_update.xml")
default_evu_kursinfo_file = pj(cereconf.FS_DATADIR, "evu_kursinfo.xml")
default_kull_info_file = pj(cereconf.FS_DATADIR, "kull_info.xml")

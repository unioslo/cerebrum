...
class FilePaths(object):
    def __init__(self, opts):
        ...
        self.misc_file = None
        # Nih extras
        self.kull_info_file = os.path.join(self.datadir, "kull_info.xml")
        ...
        for o, val in opts:
            ...
            # Nih extras
                ...
                self.kull_info_file = set_filepath(self.datadir, val)


class ImportFromFsNih(ImportFromFs):
    def __init__(self, fs):
        super(ImportFromFsNih, self).__init__(fs)
    ...
    for o, val in opts:
        try:
            if o in ('-p',):
                ...
                fsimporter.write_kull_info(file_paths.kull_info_file)

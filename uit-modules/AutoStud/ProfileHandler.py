...
from Cerebrum.modules.no.uit.AutoStud.ProfileConfig import StudconfigParser
from Cerebrum.modules.no.uit.AutoStud.Util import AutostudError
from Cerebrum.modules.no.uit.AutoStud import DiskTool
...
class Profile(object):
    ...
    def get_disk(self, disk_spread, current_disk=None,
        ...
        # Detect conflicting disks at same 'niv�kode'

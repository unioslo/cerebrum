...
class BofhdUtils(object):
    ...
    def release_guest(self, guest, operator_id):
        ...
        trait = ac.get_trait(self.co.trait_uit_guest_owner)
        if trait is None:
        ...
        ac.populate_trait(self.co.trait_uit_guest_owner, target_id=None)
        ...
        br.add_request(operator_id, br.now,
                       ...
                       state_data=int(self.co.spread_uit_nis_user))
    ...
    def get_owner(self, guestname):
        ...
        owner = ac.get_trait(self.co.trait_uit_guest_owner)
        if not owner:
    ...
    def list_guest_users(self, owner_id=NotSet, include_comment=False,
        ...
        for row in ac.list_traits(self.co.trait_uit_guest_owner,
    ...
    def list_guests_info(self):
        ...
        for row in ac.list_traits(self.co.trait_uit_guest_owner, return_name=True):
    ...
    def _alloc_guest(self, guest, end_date, comment, owner_id, operator_id):
        ...
        ac.clear()
        ac.find_by_name(guest)
        if ac.get_trait(self.co.trait_uit_guest_owner)['target_id']:
        ...
        if comment == '':
            comment = None
        ac.populate_trait(self.co.trait_uit_guest_owner, target_id=owner_id,
                          strval=comment)
        ac.write_db()
        # Password

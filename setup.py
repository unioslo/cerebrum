...
data_files = [
    ...
    ({'path': "%s/cerebrum/contrib/greg" % sharedir,
      'owner': cerebrum_user,
      'mode': 0755},
     [('contrib/greg/*.py', 0755)]),
    ...
    ({'path': "%s/cerebrum/contrib/hr-import" % sharedir,
      'owner': cerebrum_user,
      'mode': 0755},
     [('contrib/hr-import/*.py', 0755)]),
    ...
    ({'path': "%s/cerebrum/contrib/no" % sharedir,
      ...
      'mode': 0755},
     [('contrib/no/*.py', 0755)]),
    ({'path': "%s/cerebrum/contrib/no/dfo" % sharedir,
      'owner': cerebrum_user,
      'mode': 0755},
     [('contrib/no/dfo/*.py', 0755)]),
    ({'path': "%s/cerebrum/contrib/orgreg" % sharedir,
      'owner': cerebrum_user,
      'mode': 0755},
     [('contrib/orgreg/*.py', 0755)]),
    ...
    ({'path': "%s/cerebrum/contrib/no/org-era" % sharedir,
      'owner': cerebrum_user,
      'mode': 0755},
     [('contrib/no/org-era/*.py', 0755)]),
    ({'path': "%s/cerebrum/contrib/tasks" % sharedir,
      'owner': cerebrum_user,
      'mode': 0755},
     [('contrib/tasks/*.py', 0755)]),

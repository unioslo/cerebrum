...
#
sbin_files = [
    ('servers/job_runner/job_runner.py', 0o755),
    ('makedb.py', 0o755)
]

if (install_servers):
    sbin_files.append(('servers/bofhd/bofhd.py', 0o755))
    sbin_files.append(('servers/event/event_daemon.py', 0o755))
...
data_files = [
    ...
    ({'path': bindir,
      'owner': cerebrum_user,
      'mode': 0o755}, bin_files),
    ({'path': "%s/cerebrum/client" % sharedir,
      'owner': cerebrum_user,
      'mode': 0o755}, share_files),
    ({'path': sysconfdir,
      'owner': cerebrum_user,
      'mode': 0o755},
     [('design/cereconf.py', 0o644),
      ('servers/bofhd/config.dat', 0o644),
      ('design/logging.ini', 0o644), ]),
    ({'path': logdir,
      'owner': cerebrum_user,
      'mode': 0o750},
     []),

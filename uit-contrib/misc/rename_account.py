    ...
    if dryrun:
        ...
        if (resp == 'Y'):
            ...
            if not dryrun:
                account_expired = '';
                if ac.is_expired():
                    account_expired = ' Imidlertid er ikke kontoen aktiv, men kan reaktiveres n�r som helst.'
            ...
            if ac.is_expired():
                riktig_brukernavn += ' Imidlertid er ikke kontoen aktiv, og vil kun sendes til AD n�r den blir reaktivert.'

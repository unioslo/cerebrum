...
class Build:
    ...
    #
    # create a sitø account for every person processed
    #
    def process_person(self, fnr):
        ...
        # TBD: 3  personer fra SITØ har i dag bare 1 tilhørighet til rot-noden. Disse må få enda en tilhørighet.
        # Hvis det ikke skjer, vil disse 3 ikke få konto.

...
op_roles = [
    ...
    ('cereweb_orakel', 'cereweb_orakel', ('account', 15850, 'TILKNYTTET')),
    ('cereweb_orakel', 'cereweb_orakel', ('person', 15850, 'TILKNYTTET')),
    ('cereweb_orakel', 'cereweb_orakel', ('person', 15850, 'TILKNYTTET')),
    ('cereweb_self', 'cereweb_self', ('my_person', None, None)),
    ('cereweb_self', 'cereweb_self', ('my_account', None, None)),
    ('cereweb_self', 'cereweb_self', ('my_group', None, None)),
    ('cereweb_self', 'cereweb_self', ('my_email', None, None)),
    ('cereweb_innsyn', 'cereweb_innsyn', ('global', None, None)),
    ('cereweb_public', 'cereweb_public', ('global', None, None)),
    ('cereweb_basic', 'cereweb_basic', ('global', None, None)),
]
